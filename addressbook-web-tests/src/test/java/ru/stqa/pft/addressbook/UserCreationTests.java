...
public class UserCreationTests {
    ...
    private void fillNewUserForm(UserData userData) {
        ...
        wd.findElement(By.name("homepage")).sendKeys(userData.getWebSite());
        wd.findElement(By.name("address2")).click();
        wd.findElement(By.name("address2")).clear();
        wd.findElement(By.name("address2")).sendKeys(userData.getAddress2());
        wd.findElement(By.name("phone2")).click();
        wd.findElement(By.name("phone2")).clear();
        wd.findElement(By.name("phone2")).sendKeys(userData.getHomePhone2());
        wd.findElement(By.name("notes")).click();
        wd.findElement(By.name("notes")).clear();
        wd.findElement(By.name("notes")).sendKeys(userData.getNotes());
    }

    private void submitNewUserForm() {wd.findElement(By.xpath("//div[@id='content']/form/input[21]")).click();}

    private void initUserCreation() {wd.findElement(By.linkText("add new")).click();}
